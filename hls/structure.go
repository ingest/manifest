...
const (
	...
	iframesStreamInfTag = "#EXT-X-I-FRAME-STREAM-INF"
	sessionDataTag      = "#EXT-X-SESSION-DATA"
	indSegmentsTag      = "#EXT-X-INDEPENDENT-SEGMENTS"
	startTag            = "#EXT-X-START"
	allowCacheTag       = "#EXT-X-ALLOW-CACHE"
	bandwidth           = "BANDWIDTH"
