...
//TODO: Figure out how to separate common attr into generic structs. There's a lot of duplicate fields at the moment.
type MPD struct {
...
type Period struct {
	XlinkHref          string           `xml:"xlink:href,attr,omitempty"`         //Optional
	XlinkActuate       string           `xml:"xlink:actuate,attr,omitempty"`      //Optional. Possible Values: onDemand, onRequest
